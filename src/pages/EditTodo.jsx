...
export default function EditTodo() {
  ...
  return (
    <>
      ...
      <Container className="p-3 glassy-effect mx-auto mt-3">
        <span>
          <img
            style={{ width: "50px" }}
            className="pb-3 me-1"
            src="https://cdn-icons-png.flaticon.com/512/3597/3597104.png"
            alt=""
          />
        </span>
        <h1 style={{ display: "inline-block" }} className="px-3">
          Edit Todo
        </h1>
